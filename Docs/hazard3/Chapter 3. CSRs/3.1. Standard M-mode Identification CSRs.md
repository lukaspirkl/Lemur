...
|------|--------|-------------|
| 31:7 | bank   | The number of continuation codes in the vendor JEP106 ID. One less than the JEP106 bank number. |
...
| 23    | x    | 1 if any custom extension is enabled (Custom Hazard3 Extensions), otherwise 0. |
