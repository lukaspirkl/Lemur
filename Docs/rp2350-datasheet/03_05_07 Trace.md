...
You must enable DMA access to the trace FIFO registers by setting the DMA bit in the ACCESSCTRL [CORESIGHT\\_TRACE](#page-840-0) register before attempting to DMA from this FIFO. Configure the DMA for DREQ 53 to select the trace FIFO.

#### **3.5.7.3. List of Trace FIFO Registers**

The trace FIFO registers start at a base address of 0x50700000 (defined as [CORESIGHT\\_TRACE\\_BASE](#page-33-0) in the SDK).

*Table 95. List of CORESIGHT\_TRACE registers*
...
#### <span id="page-89-0"></span>**[CORESIGHT\\_TRACE:](#page-89-1) CTRL\_STATUS Register**
...
*Table 96. CTRL\_STATUS Register*
...
# <span id="page-90-1"></span>**[CORESIGHT\\_TRACE:](#page-89-1) TRACE\_CAPTURE\_FIFO Register**
...
*Table 97. TRACE\_CAPTURE\_FIF O Register*
