...
- [FPU:](#page-127-1) Single precision FPU
- DSP: DSP extension
- [SECEXT:](#page-127-2) Security extensions
...
- ITM: [DWT](#page-145-0) and ITM trace
- [ETM](#page-128-1): ETM trace
- [MTB:](#page-128-2) no MTB trace
- WIC: Wake up interrupt controller
- WICLINES: 55: All external interrupts and 3 internal events: NMI, RVEX, Debug
- [CTI](#page-128-3): Cross trigger interface
- RAR: reset all registers on power up
- [UNCROSS\\_I\\_D:](#page-125-0) Modify internal address map
...
Each Cortex-M33 core has its own interrupt controller which can individually mask out interrupt sources as required. The same interrupts route to both Cortex-M33 cores.
...
### <span id="page-125-0"></span>**3.7.2.1. Modifications by Raspberry Pi**
...
In [Section 3.7.2,](#page-124-1) we refer to this feature as UNCROSS\_I\_D.
...
#### <span id="page-127-2"></span>**3.7.2.3. Security attribution and memory protection**

The Cortex-M33 processor supports the Armv8-M Protected Memory System Architecture (PMSA) that provides programmable support for [memory protection](https://developer.arm.com/documentation/107565/0101/Memory-protection/Memory-Protection-Unit) using a number of software controllable regions. RP2350 supports 8 programmable regions.
...
#### <span id="page-127-1"></span>**3.7.2.4. Floating-Point Unit (FPU)**
...
#### <span id="page-127-0"></span>**3.7.2.5. NVIC**
...
See the Arm [CoreSight MTB-M33 Technical Reference Manual](https://developer.arm.com/documentation/100231/latest/) for more information.
...
- Interfaces suitable for:
  - Passing on-chip data through a Trace Port Interface Unit (TPIU) to a Trace Port Analyzer (TPA) via a 4-bit DDR output selected as a GPIO function (see [Section 3.5.7\)](#page-88-0)
...
## <span id="page-128-0"></span>**3.7.3. Compliance**
...
- [Arm AMBA 5 AHB Protocol Specification](https://developer.arm.com/docs/ihi0033/latest)
- [AMBA APB Protocol Version 2.0 Specification](https://developer.arm.com/documentation/ihi0024/latest/)
- [Arm AMBA 4 ATB Protocol Specification ATBv1.0 and ATBv1.1](https://developer.arm.com/documentation/ihi0032/b/)

The processor also provides a Q-Channel interface. For more information, see the [AMBA Low Power Interface](https://developer.arm.com/documentation/ihi0068/latest/) [Specification](https://developer.arm.com/documentation/ihi0068/latest/).

#### **3.7.3.3. Debug**

The debug features of the processor implement the Arm Debug Interface Architecture. For more information, see the [Arm Debug Interface Architecture Specification, ADIv5.0 to ADIv5.2.](https://developer.arm.com/documentation/ihi0031/latest/)
...
For more information, see the [Arm CoreSight ETM-M33 Technical Reference Manual.](https://developer.arm.com/documentation/100232/latest/)
...
For more information about the FPU and FPSCR, see the [Armv8-M Architecture Reference Manual.](https://developer.arm.com/documentation/ddi0553/latest/)
...
- If FPU domain includes state retention logic, disable the FPU by clearing the [CPACR.](#page-193-0)CP10 and [CPACR.](#page-193-0)CP11 bitfields.
- If FPU domain does not include state retention logic, disable the FPU by clearing the [CPACR](#page-193-0).CP10 and [CPACR](#page-193-0).CP11 bitfields and set both the CPPWR.SU10 and CPPWR.SU11 bitfields to 1.
