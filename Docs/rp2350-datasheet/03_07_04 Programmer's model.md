...
If [CCR](#page-183-0).UNALIGN\_TRP for the current Security state is set, any unaligned accesses generate a fault.
...
The register fields [SAU\\_CTRL](#page-198-0).EN and [SAU\\_CTRL](#page-198-0).ALLNS control the enable state of the SAU and the default security level when the SAU is disabled. Both [SAU\\_CTRL](#page-198-0).EN and [SAU\\_CTRL](#page-198-0).ALLNS reset to zero disabling the SAU and setting all memory, apart from some specific regions in the PPB space to Secure level. If the SAU is not enabled, and [SAU\\_CTRL.](#page-198-0)ALLNS is zero, then the IDAU cannot set any regions of memory to a security level lower than Secure, for example Secure NSC or NS. If the SAU is enabled, then [SAU\\_CTRL](#page-198-0).ALLNS does not affect the Security level of memory.
...
The DWT is a full configuration, containing four comparators ([DWT\\_COMP0](#page-166-0) to [DWT\\_COMP3](#page-168-0)). These comparators support the following features:

- Hardware watchpoint support
- Hardware trace packet support
- CMPMATCH support for ETM/MTB/CTI triggers
- Cycle counter matching support ([DWT\\_COMP0](#page-166-0) only)
- Instruction address matching support
- Data address matching support
- Data value matching support ([DWT\\_COMP1](#page-167-0) only in a reduced DWT, [DWT\\_COMP3](#page-168-0) only in a Full DWT)
- Linked/limit matching support ([DWT\\_COMP1](#page-167-0) and [DWT\\_COMP3](#page-168-0) only)

The DWT contains counters for:

- Cycles ([DWT\\_CYCCNT.](#page-165-0)CYCCNT)
...
<span id="page-148-0"></span>The Arm Cortex-M33 registers start at a base address of 0xe0000000, defined as [PPB\\_BASE](#page-34-0) in the SDK.
...
# <span id="page-159-0"></span>**[M33](#page-148-1): ITM\_STIM0, ITM\_STIM1, …, ITM\_STIM30, ITM\_STIM31 Registers**
...
*Table 121. ITM\_STIM0, ITM\_STIM1, …, ITM\_STIM30, ITM\_STIM31 Registers*
...
# <span id="page-159-1"></span>**[M33](#page-148-1): ITM\_TER0 Register**
...
#### <span id="page-160-0"></span>**[M33](#page-148-1): ITM\_TCR Register**
...
## <span id="page-160-1"></span>**[M33](#page-148-1): INT\_ATREADY Register**
...
*Table 125. INT\_ATREADY Register*
...
#### <span id="page-160-2"></span>**[M33](#page-148-1): INT\_ATVALID Register**

**Offset**: 0x00ef8

Integration Mode: Write ATB Valid

*Table 126. INT\_ATVALID Register*
...
# <span id="page-161-0"></span>**[M33](#page-148-1): ITM\_ITCTRL Register**
...
*Table 127. ITM\_ITCTRL Register*
...
# <span id="page-161-1"></span>**[M33](#page-148-1): ITM\_DEVARCH Register**
...
*Table 128. ITM\_DEVARCH Register*
...
### <span id="page-161-2"></span>**[M33](#page-148-1): ITM\_DEVTYPE Register**
...
*Table 129. ITM\_DEVTYPE Register*
...
# <span id="page-161-3"></span>**[M33](#page-148-1): ITM\_PIDR4 Register**
...
# <span id="page-162-0"></span>**[M33](#page-148-1): ITM\_PIDR5 Register**

**Offset**: 0x00fd4 **Description**

Provides CoreSight discovery information for the ITM

*Table 131. ITM\_PIDR5 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

# <span id="page-162-1"></span>**[M33](#page-148-1): ITM\_PIDR6 Register**
...
*Table 132. ITM\_PIDR6 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

#### <span id="page-162-2"></span>**[M33](#page-148-1): ITM\_PIDR7 Register**
...
*Table 133. ITM\_PIDR7 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

#### <span id="page-162-3"></span>**[M33](#page-148-1): ITM\_PIDR0 Register**
...
# <span id="page-163-0"></span>**[M33](#page-148-1): ITM\_PIDR1 Register**
...
# <span id="page-163-1"></span>**[M33](#page-148-1): ITM\_PIDR2 Register**
...
# <span id="page-163-2"></span>**[M33](#page-148-1): ITM\_PIDR3 Register**
...
#### <span id="page-163-3"></span>**[M33](#page-148-1): ITM\_CIDR0 Register**
...
# <span id="page-164-0"></span>**[M33](#page-148-1): ITM\_CIDR1 Register**
...
# <span id="page-164-1"></span>**[M33](#page-148-1): ITM\_CIDR2 Register**
...
# <span id="page-164-2"></span>**[M33](#page-148-1): ITM\_CIDR3 Register**
...
#### <span id="page-164-3"></span>**[M33](#page-148-1): DWT\_CTRL Register**
...
# <span id="page-165-0"></span>**[M33](#page-148-1): DWT\_CYCCNT Register**
...
*Table 143. DWT\_CYCCNT Register*
...
#### <span id="page-165-1"></span>**[M33](#page-148-1): DWT\_EXCCNT Register**
...
*Table 144. DWT\_EXCCNT Register*
...
# <span id="page-166-1"></span>**[M33](#page-148-1): DWT\_LSUCNT Register**
...
*Table 145. DWT\_LSUCNT Register*
...
# <span id="page-166-2"></span>**[M33](#page-148-1): DWT\_FOLDCNT Register**
...
*Table 146. DWT\_FOLDCNT Register*
...
# <span id="page-166-0"></span>**[M33](#page-148-1): DWT\_COMP0 Register**

**Offset**: 0x01020

*Table 147. DWT\_COMP0 Register*

| Bits | Description                                                   | Type | Reset      |
|------|---------------------------------------------------------------|------|------------|
| 31:0 | Provides a reference value for use by watchpoint comparator 0 | RW   | 0x00000000 |

#### <span id="page-166-3"></span>**[M33](#page-148-1): DWT\_FUNCTION0 Register**
...
*Table 148. DWT\_FUNCTION0 Register*
...
# <span id="page-167-0"></span>**[M33](#page-148-1): DWT\_COMP1 Register**

**Offset**: 0x01030

*Table 149. DWT\_COMP1 Register*

| Bits | Description                                                   | Type | Reset      |
|------|---------------------------------------------------------------|------|------------|
| 31:0 | Provides a reference value for use by watchpoint comparator 1 | RW   | 0x00000000 |

# <span id="page-167-1"></span>**[M33](#page-148-1): DWT\_FUNCTION1 Register**
...
*Table 150. DWT\_FUNCTION1 Register*
...
#### <span id="page-167-2"></span>**[M33](#page-148-1): DWT\_COMP2 Register**

**Offset**: 0x01040

*Table 151. DWT\_COMP2 Register*

| Bits | Description                                                   | Type | Reset      |
|------|---------------------------------------------------------------|------|------------|
| 31:0 | Provides a reference value for use by watchpoint comparator 2 | RW   | 0x00000000 |

# <span id="page-168-1"></span>**[M33](#page-148-1): DWT\_FUNCTION2 Register**
...
*Table 152. DWT\_FUNCTION2 Register*
...
# <span id="page-168-0"></span>**[M33](#page-148-1): DWT\_COMP3 Register**

**Offset**: 0x01050

*Table 153. DWT\_COMP3 Register*

| Bits | Description                                                   | Type | Reset      |
|------|---------------------------------------------------------------|------|------------|
| 31:0 | Provides a reference value for use by watchpoint comparator 3 | RW   | 0x00000000 |

# <span id="page-168-2"></span>**[M33](#page-148-1): DWT\_FUNCTION3 Register**
...
*Table 154. DWT\_FUNCTION3 Register*
...
# **[M33](#page-148-1): DWT\_DEVARCH Register**
...
*Table 155. DWT\_DEVARCH Register*
...
# <span id="page-169-0"></span>**[M33](#page-148-1): DWT\_DEVTYPE Register**
...
*Table 156. DWT\_DEVTYPE Register*
...
#### <span id="page-169-1"></span>**[M33](#page-148-1): DWT\_PIDR4 Register**

**Offset**: 0x01fd0 **Description**

Provides CoreSight discovery information for the DWT

*Table 157. DWT\_PIDR4 Register*
...
#### <span id="page-169-2"></span>**[M33](#page-148-1): DWT\_PIDR5 Register**
...
*Table 158. DWT\_PIDR5 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

# <span id="page-170-0"></span>**[M33](#page-148-1): DWT\_PIDR6 Register**
...
*Table 159. DWT\_PIDR6 Register*

| Bits |      | Description | Type | Reset |
|------|------|-------------|------|-------|
|      | 31:0 | Reserved.   | -    | -     |

# <span id="page-170-1"></span>**[M33](#page-148-1): DWT\_PIDR7 Register**
...
*Table 160. DWT\_PIDR7 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

# <span id="page-170-2"></span>**[M33](#page-148-1): DWT\_PIDR0 Register**
...
# <span id="page-170-3"></span>**[M33](#page-148-1): DWT\_PIDR1 Register**
...
## <span id="page-170-4"></span>**[M33](#page-148-1): DWT\_PIDR2 Register**
...
# <span id="page-171-0"></span>**[M33](#page-148-1): DWT\_PIDR3 Register**
...
# <span id="page-171-1"></span>**[M33](#page-148-1): DWT\_CIDR0 Register**
...
# <span id="page-171-2"></span>**[M33](#page-148-1): DWT\_CIDR1 Register**
...
#### <span id="page-171-3"></span>**[M33](#page-148-1): DWT\_CIDR2 Register**
...
# <span id="page-172-0"></span>**[M33](#page-148-1): DWT\_CIDR3 Register**
...
# <span id="page-172-1"></span>**[M33](#page-148-1): FP\_CTRL Register**
...
#### <span id="page-172-2"></span>**[M33](#page-148-1): FP\_REMAP Register**
...
# <span id="page-173-0"></span>**[M33](#page-148-1): FP\_COMP0, FP\_COMP1, …, FP\_COMP6, FP\_COMP7 Registers**
...
*Table 171. FP\_COMP0, FP\_COMP1, …, FP\_COMP6, FP\_COMP7 Registers*
...
# <span id="page-173-1"></span>**[M33](#page-148-1): FP\_DEVARCH Register**
...
*Table 172. FP\_DEVARCH Register*
...
#### <span id="page-173-2"></span>**[M33](#page-148-1): FP\_DEVTYPE Register**
...
*Table 173. FP\_DEVTYPE Register*
...
## <span id="page-173-3"></span>**[M33](#page-148-1): FP\_PIDR4 Register**

**Offset**: 0x02fd0

Provides CoreSight discovery information for the FP

*Table 174. FP\_PIDR4 Register*
...
# <span id="page-174-0"></span>**[M33](#page-148-1): FP\_PIDR5 Register**
...
*Table 175. FP\_PIDR5 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

# <span id="page-174-1"></span>**[M33](#page-148-1): FP\_PIDR6 Register**
...
*Table 176. FP\_PIDR6 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

#### <span id="page-174-2"></span>**[M33](#page-148-1): FP\_PIDR7 Register**
...
*Table 177. FP\_PIDR7 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

#### <span id="page-174-3"></span>**[M33](#page-148-1): FP\_PIDR0 Register**
...
# <span id="page-175-0"></span>**[M33](#page-148-1): FP\_PIDR1 Register**
...
# <span id="page-175-1"></span>**[M33](#page-148-1): FP\_PIDR2 Register**
...
# <span id="page-175-2"></span>**[M33](#page-148-1): FP\_PIDR3 Register**
...
#### <span id="page-175-3"></span>**[M33](#page-148-1): FP\_CIDR0 Register**
...
# <span id="page-176-0"></span>**[M33](#page-148-1): FP\_CIDR1 Register**
...
# <span id="page-176-1"></span>**[M33](#page-148-1): FP\_CIDR2 Register**
...
### <span id="page-176-2"></span>**[M33](#page-148-1): FP\_CIDR3 Register**
...
#### <span id="page-177-1"></span>**[M33](#page-148-1): SYST\_CSR Register**
...
# <span id="page-178-0"></span>**[M33](#page-148-1): SYST\_RVR Register**
...
# <span id="page-178-1"></span>**[M33](#page-148-1): SYST\_CVR Register**
...
## <span id="page-178-2"></span>**[M33](#page-148-1): SYST\_CALIB Register**
...
*Table 191. SYST\_CALIB Register*
...
# <span id="page-179-1"></span>**[M33](#page-148-1): NVIC\_ISER0, NVIC\_ISER1 Registers**
...
*Table 192. NVIC\_ISER0, NVIC\_ISER1 Registers*
...
# <span id="page-179-2"></span>**[M33](#page-148-1): NVIC\_ICER0, NVIC\_ICER1 Registers**
...
*Table 193. NVIC\_ICER0, NVIC\_ICER1 Registers*
...
# <span id="page-179-0"></span>**[M33](#page-148-1): NVIC\_ISPR0, NVIC\_ISPR1 Registers**
...
*Table 194. NVIC\_ISPR0, NVIC\_ISPR1 Registers*
...
# <span id="page-179-3"></span>**[M33](#page-148-1): NVIC\_ICPR0, NVIC\_ICPR1 Registers**
...
*Table 195. NVIC\_ICPR0, NVIC\_ICPR1 Registers*
...
## <span id="page-179-4"></span>**[M33](#page-148-1): NVIC\_IABR0, NVIC\_IABR1 Registers**
...
*Table 196. NVIC\_IABR0, NVIC\_IABR1 Registers*
...
# <span id="page-180-2"></span>**[M33](#page-148-1): NVIC\_ITNS0, NVIC\_ITNS1 Registers**
...
*Table 197. NVIC\_ITNS0, NVIC\_ITNS1 Registers*

| Bits | Description                                                                                | Type | Reset      |
|------|--------------------------------------------------------------------------------------------|------|------------|
| 31:0 | ITNS: For ITNS[m] in NVIC_ITNS*n, `IAAMO the target Security state for<br>interrupt 32*n+m | RW   | 0x00000000 |

# <span id="page-180-1"></span>**[M33](#page-148-1): NVIC\_IPR0, NVIC\_IPR1, …, NVIC\_IPR14, NVIC\_IPR15 Registers**
...
*Table 198. NVIC\_IPR0, NVIC\_IPR1, …, NVIC\_IPR14, NVIC\_IPR15 Registers*
...
### <span id="page-188-2"></span>**[M33](#page-148-1): ID\_PFR0 Register**
...
#### <span id="page-188-3"></span>**[M33](#page-148-1): ID\_PFR1 Register**
...
# <span id="page-189-0"></span>**[M33](#page-148-1): ID\_DFR0 Register**
...
# <span id="page-189-1"></span>**[M33](#page-148-1): ID\_AFR0 Register**
...
#### <span id="page-189-2"></span>**[M33](#page-148-1): ID\_MMFR0 Register**
...
# <span id="page-189-3"></span>**[M33](#page-148-1): ID\_MMFR1 Register**

**Offset**: 0x0ed54

Provides information about the implemented memory model and memory management support

*Table 219. ID\_MMFR1 Register*

| Bits | Description | Type | Reset |
|------|-------------|------|-------|
| 31:0 | Reserved.   | -    | -     |

# <span id="page-190-0"></span>**[M33](#page-148-1): ID\_MMFR2 Register**
...
# <span id="page-190-1"></span>**[M33](#page-148-1): ID\_MMFR3 Register**
...
# <span id="page-190-2"></span>**[M33](#page-148-1): ID\_ISAR0 Register**
...
# <span id="page-191-0"></span>**[M33](#page-148-1): ID\_ISAR1 Register**
...
# <span id="page-191-1"></span>**[M33](#page-148-1): ID\_ISAR2 Register**
...
#### <span id="page-191-2"></span>**[M33](#page-148-1): ID\_ISAR3 Register**
...
# <span id="page-192-0"></span>**[M33](#page-148-1): ID\_ISAR4 Register**
...
# <span id="page-192-1"></span>**[M33](#page-148-1): ID\_ISAR5 Register**
...
# <span id="page-194-0"></span>**[M33](#page-148-1): MPU\_TYPE Register**
...
#### <span id="page-194-1"></span>**[M33](#page-148-1): MPU\_CTRL Register**
...
# **[M33](#page-148-1): MPU\_RNR Register**
...
# <span id="page-195-0"></span>**[M33](#page-148-1): MPU\_RBAR Register**
...
# <span id="page-195-1"></span>**[M33](#page-148-1): MPU\_RLAR Register**
...
#### <span id="page-195-2"></span>**[M33](#page-148-1): MPU\_RBAR\_A1 Register**
...
*Table 236. MPU\_RBAR\_A1 Register*
...
# <span id="page-196-0"></span>**[M33](#page-148-1): MPU\_RLAR\_A1 Register**
...
*Table 237. MPU\_RLAR\_A1 Register*
...
# <span id="page-196-1"></span>**[M33](#page-148-1): MPU\_RBAR\_A2 Register**
...
*Table 238. MPU\_RBAR\_A2 Register*
...
#### <span id="page-196-2"></span>**[M33](#page-148-1): MPU\_RLAR\_A2 Register**
...
*Table 239. MPU\_RLAR\_A2 Register*
...
# <span id="page-197-0"></span>**[M33](#page-148-1): MPU\_RBAR\_A3 Register**
...
*Table 240. MPU\_RBAR\_A3 Register*
...
# <span id="page-197-1"></span>**[M33](#page-148-1): MPU\_RLAR\_A3 Register**
...
*Table 241. MPU\_RLAR\_A3 Register*
...
#### <span id="page-197-2"></span>**[M33](#page-148-1): MPU\_MAIR0 Register**
...
# <span id="page-198-1"></span>**[M33](#page-148-1): MPU\_MAIR1 Register**
...
# <span id="page-198-0"></span>**[M33](#page-148-1): SAU\_CTRL Register**
...
# <span id="page-198-2"></span>**[M33](#page-148-1): SAU\_TYPE Register**
...
#### <span id="page-198-3"></span>**[M33](#page-148-1): SAU\_RNR Register**
...
# <span id="page-199-0"></span>**[M33](#page-148-1): SAU\_RBAR Register**
...
# <span id="page-199-1"></span>**[M33](#page-148-1): SAU\_RLAR Register**
...
These registers start at a base address of 0xe0080000, defined as [EPPB\\_BASE](#page-34-0) in the SDK.

*Table 361. List of M33\_EPPB registers*
...
# <span id="page-232-0"></span>**[M33\\_EPPB](#page-232-3): NMI\_MASK0 Register**

**Offset**: 0x0

*Table 362. NMI\_MASK0 Register*

| Bits | Description                                                                                             | Type | Reset      |
|------|---------------------------------------------------------------------------------------------------------|------|------------|
| 31:0 | NMI mask for IRQs 0 through 31. This register is core-local, and is reset by a<br>processor warm reset. | RW   | 0x00000000 |

# <span id="page-232-1"></span>**[M33\\_EPPB](#page-232-3): NMI\_MASK1 Register**

**Offset**: 0x4

*Table 363. NMI\_MASK1 Register*
...
### <span id="page-232-2"></span>**[M33\\_EPPB](#page-232-3): SLEEPCTRL Register**
