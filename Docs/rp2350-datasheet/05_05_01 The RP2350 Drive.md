...
It is possible, based on the partition table or family id, that the UF2 is not downloadable anywhere in flash, in which case it will be ignored. Further detail can be discovered via [GET\\_INFO - UF2\\_STATUS](#page-407-0) On the completed download of an entire valid UF2 file, RP2350 automatically reboots to run the newly downloaded code.
