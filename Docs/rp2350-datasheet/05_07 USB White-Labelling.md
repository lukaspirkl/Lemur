...
- 1. Write the OTP location of the white-label data structure via [USB\\_WHITE\\_LABEL\\_ADDR](#page-1313-0) (see that register description for the data structure contents).
- 2. Initialize the fields you wish to override in the white-label data structure and mark them valid.
- 3. Set [USB\\_BOOT\\_FLAGS.](#page-1311-1)WHITE\_LABEL\_ADDR\_VALID to mark the white-labelling as valid.
