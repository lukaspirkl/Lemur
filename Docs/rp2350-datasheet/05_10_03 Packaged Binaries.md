...
Alternatively you can use an absolute LOAD\_MAP, with the storage\_address in Flash and the runtime\_address in SRAM, but these binaries will can only be run after storing in flash and cannot be booted directly in SRAM for debugging.
