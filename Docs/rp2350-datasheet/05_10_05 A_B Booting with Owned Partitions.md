...
The concept of [owned partitions](#page-363-1) applies when:

- you require separate data partitions (which generally won't contain a [block loop](#page-356-1)), but
...
Only the [get\\_uf2\\_target\\_partition\(\)](#page-392-0) bootrom function considers owner partitions. The [pick\\_ab\\_partition\(\)](#page-394-0) function always pick solely based on the A/B partition it is passed, in other words if passed partition 2, it would not look at partitions 0 and 1.
