...
#### <span id="page-519-2"></span>**8.1.5.1. Configuring a clock generator**

The SDK defines an enum of clocks:

*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware\\_structs/include/hardware/structs/clocks.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware_structs/include/hardware/structs/clocks.h#L30-L42) Lines 30 - 42*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware\\_structs/include/hardware/structs/clocks.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware_structs/include/hardware/structs/clocks.h#L116-L137) Lines 116 - 137*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L40-L133) Lines 40 - 133*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/pico\\_runtime\\_init/runtime\\_init\\_clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/pico_runtime_init/runtime_init_clocks.c#L100-L104) Lines 100 - 104*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L137-L139) Lines 137 - 139*
...
- 2. Set the mux position of the source they want to measure. See [FC0\\_SRC.](#page-543-1)
- 3. Wait for the DONE status bit in [FC0\\_STATUS](#page-544-0) to be set.
- 4. Read the result.

The SDK defines a frequency\_count function which takes the source as an argument and returns the frequency in kHz:

*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L147-L174) Lines 147 - 174*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/include/hardware/clocks.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/include/hardware/clocks.h#L377-L379) Lines 377 - 379*
...
The frequency counter can also be used in a test mode. This allows the hardware to check if the frequency is between a minimum and a maximum frequency, set in [FC0\\_MIN\\_KHZ](#page-542-1) and [FC0\\_MAX\\_KHZ](#page-543-2). This mode will set one of the following bits in [FC0\\_STATUS](#page-544-0) when DONE is set:
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L245-L276) Lines 245 - 276*
...
247 // table. The sources for each gpout generators are the same
...
254 else if (gpio == 13) gpclk = clk_gpout0;
255 else if (gpio == 15) gpclk = clk_gpout1;
256 else {
257 invalid_params_if(HARDWARE_CLOCKS, true);
258 }
259 
260 invalid_params_if(HARDWARE_CLOCKS, div_int >> REG_FIELD_WIDTH(
  CLOCKS_CLK_GPOUT0_DIV_INT));
261 // Set up the gpclk generator
262 clocks_hw->clk[gpclk].ctrl = (src << CLOCKS_CLK_GPOUT0_CTRL_AUXSRC_LSB) |
263 CLOCKS_CLK_GPOUT0_CTRL_ENABLE_BITS;
264 #ifdef REG_FIELD_WIDTH(CLOCKS_CLK_GPOUT0_DIV_FRAC) == 16
...
268 #else
269 #error unsupported number of fractional bits
270 #endif
271 
...
#### <span id="page-524-0"></span>**8.1.5.4. Configuring a GPIO input clock**

*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L313-L343) Lines 313 - 343*
...
318 else if (gpio == 12) gpin = 0;
319 else if (gpio == 14) gpin = 1;
320 else {
321 invalid_params_if(HARDWARE_CLOCKS, true);
322 }
323 
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2\\_common/hardware\\_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L221-L243) Lines 221 - 243*
...
The SLEEP\_EN registers set what clocks run in sleep mode. The hello\_sleep example ([hello\\_sleep\\_aon.c](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c) [in the](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c) [pico](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c)[playground](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c) [GitHub repository](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c)) illustrates how to put the chip to sleep until the AON Timer fires.

![](_page_526_Figure_5.jpeg)
