...
<span id="page-1045-0"></span>![](_page_1045_Figure_2.jpeg)
...
The PCLK and SSPCLK clock inputs in [Figure 90](#page-1045-0) are connected to the clk\_sys and clk\_peri system-level clock nets on RP2350, respectively. By default, clk\_peri attaches directly to the system clock. However, you can detach it to maintain constant SPI frequency if the system clock is varied dynamically. See [Figure 32](#page-510-2) for an overview of the RP2350 clock architecture.
...
The PrimeCell SSP provides an interface to connect to a DMA controller, see [Section 12.3.4.16](#page-1056-0).
