...
The temperature sensor's bias source must be enabled before use, via [CS](#page-1070-4).TS\_EN. This increases current consumption on ADC\_AVDD by approximately 40 μA.
