...
![](_page_1138_Figure_12.jpeg)

*Prerequisite knowledge required*

This section requires knowledge of the USB protocol. If you aren't yet familiar with the USB protocol, we recommend [USB Made Simple](http://www.usbmadesimple.co.uk/). For formal definitions of the terminology used in this section, see the [USB 2.0 Specification.](https://www.usb.org/document-library/usb-20-specification)
...
#### <span id="page-1139-1"></span>**12.7.1.1.3. USB DPRAM**
...
As peripheral addresses are marked Exempt in the IDAU [\(Section 10.2.2\)](#page-817-0), the SAU configuration for this address range is ignored. Accesses to USB DPRAM are controlled only by the processor MPU/PMP and the ACCESSCTRL [USBCTRL](#page-837-0) register.
