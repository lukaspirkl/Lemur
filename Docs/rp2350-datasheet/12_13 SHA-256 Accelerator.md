...
- 1. Initialise the algorithm state by writing a 1 to [CSR.](#page-1220-1)START.
- 2. Write the message to the [WDATA](#page-1222-1) register, polling [CSR](#page-1220-1).WDATA\_RDY in between writes.

- 3. Write additional trailer and padding data to [WDATA](#page-1222-1), as described in [Section 12.13.1](#page-1219-0) below.
- 4. Poll [CSR](#page-1220-1).SUM\_VLD to wait for the last block to be digested.
- 5. Read the 256-bit result from the 8 read-only result registers starting at [SUM0.](#page-1222-0)
