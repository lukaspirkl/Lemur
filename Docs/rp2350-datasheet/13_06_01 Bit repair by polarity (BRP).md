...
When you read an OTP value through an ECC alias [\(Section 13.1\)](#page-1265-1), BRP checks for two ones in bits 23:22. When both bits 23 and 22 are set, BRP inverts the entire row before passing it to the modified Hamming code stage.
