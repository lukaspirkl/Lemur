# <span id="page-821-0"></span>**10.6.2. Bus Access Control**
...
- The NSP bit allow access from:
  ...
  - Privileged Arm software running in the Secure domain on core 1, when [FORCE_CORE_NS.](#page-827-0)CORE1 is set
  - Machine-mode RISC-V software running on core 1, when [FORCE_CORE_NS](#page-827-0).CORE1 is set
...
- The NSU bit must be set, in addition to the NSP bit, to allow access from:
  ...
  - User (unprivileged) Arm software running on core 1 when [FORCE_CORE_NS](#page-827-0).CORE1 is set
...
- XIP_AUX (DMA FIFOs) [\(Section 4.4.3\)](#page-345-1)
