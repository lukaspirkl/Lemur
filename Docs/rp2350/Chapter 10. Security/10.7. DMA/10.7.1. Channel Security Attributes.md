# <span id="page-865-0"></span>**10.7.1. Channel Security Attributes**

Each channel is assigned a security level using the per-channel registers starting at [SECCFG_CH0.](#page-1134-0) This defines:
