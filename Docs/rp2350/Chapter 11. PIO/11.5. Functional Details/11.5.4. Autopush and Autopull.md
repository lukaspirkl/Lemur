# <span id="page-903-0"></span>**11.5.4. Autopush and Autopull**
...
Autopush must not be enabled when SHIFTCTRL_FJOIN_RX_PUT or SHIFTCTRL_FJOIN_RX_PUTGET is set. Its operation in this state is undefined.
