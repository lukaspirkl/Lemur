# <span id="page-918-0"></span>**11.6.3. UART TX**
...
<span id="page-918-1"></span>![](_page_918_Figure_6.jpeg)
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio#L8-L18) Lines 8 - 18*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio#L24-L51) Lines 24 - 51*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio#L53-L55) Lines 53 - 55*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.pio#L57-L60) Lines 57 - 60*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.c](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_tx/uart_tx.c)*
