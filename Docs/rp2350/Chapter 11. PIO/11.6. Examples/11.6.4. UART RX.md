# <span id="page-920-0"></span>**11.6.4. UART RX**

Recalling [Figure 57](#page-918-1) showing the format of an 8n1 UART:
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio#L8-L19) Lines 8 - 19*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio#L44-L63) Lines 44 - 63*
...
The second example does not use autopush ([Section 11.5.4](#page-903-0)), preferring instead to use an explicit push instruction, so that it can condition the push on whether a correct stop bit is seen. The .pio file includes a helper function which configures the state machine and connects it to a GPIO with the pull-up enabled:

*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio#L67-L85) Lines 67 - 85*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.pio#L87-L93) Lines 87 - 93*
...
*Pico Examples: [https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.c](https://github.com/raspberrypi/pico-examples/blob/master/pio/uart_rx/uart_rx.c)*
