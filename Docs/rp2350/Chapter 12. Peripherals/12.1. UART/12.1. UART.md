# <span id="page-958-1"></span>**12.1. UART**
...
- Programmable baud rate generator, clocked by clk_peri (see [Figure 32](#page-510-2))
...
Each UART can be connected to a number of GPIO pins as defined in the GPIO muxing [table](#page-590-0) in [Section 9.4](#page-586-0). Connections to the GPIO muxing use a prefix including the UART instance name uart0_ or uart1_, and include the following:
...
The UARTCLK is driven from clk_peri, and PCLK is driven from the system clock clk_sys (see [Figure 32](#page-510-2)).
