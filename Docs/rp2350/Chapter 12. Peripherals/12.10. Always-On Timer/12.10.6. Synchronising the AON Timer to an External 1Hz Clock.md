# <span id="page-1198-0"></span>**12.10.6. Synchronising the AON Timer to an External 1Hz Clock**
...
To use the hardware synchronisation feature, configure the GPIO source as described in [Section 12.10.7](#page-1198-1). Then, enable the feature by writing a 1 to [TIMER](#page-478-1).USE_GPIO_1HZ. This can be set at any time, it is not necessary to stop the AON Timer. When the operation is complete [TIMER.](#page-478-1)USE_GPIO_1HZ will self-clear and [TIMER](#page-478-1).USING_GPIO_1HZ will be set.
