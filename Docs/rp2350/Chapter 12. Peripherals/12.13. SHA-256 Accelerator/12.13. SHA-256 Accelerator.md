# <span id="page-1218-0"></span>**12.13. SHA-256 Accelerator**
...
- 2. Write the message to the [WDATA](#page-1222-1) register, polling [CSR](#page-1220-1).WDATA_RDY in between writes.

- 3. Write additional trailer and padding data to [WDATA](#page-1222-1), as described in [Section 12.13.1](#page-1219-0) below.
- 4. Poll [CSR](#page-1220-1).SUM_VLD to wait for the last block to be digested.
