# <span id="page-1231-0"></span>**12.14.4. Address Translation**
...
This is done automatically when the booted image is inside of a flash partition [\(Section 5.1.2](#page-354-2)), and can be adjusted manually based on a rolling window delta specified in the IMAGE_DEF of the launched executable [\(Section 5.1.4\)](#page-355-1).
