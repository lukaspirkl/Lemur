# <span id="page-1252-0"></span>**12.15.4. BUSCTRL**

This block provides basic controls and monitoring for the system bus fabric.

#### **12.15.4.1. Bus Priority**

RP2350 implements a dynamic bus priority scheme described in [Section 2.1.1](#page-25-0). The [BUS_PRIORITY](#page-1253-0) register implements the priority controls for this scheme.
...
The Bus Fabric registers start at a base address of 0x40068000 (defined as [BUSCTRL_BASE](#page-31-1) in SDK).
...
# <span id="page-1253-0"></span>**[BUSCTRL](#page-1253-1): BUS_PRIORITY Register**
...
# <span id="page-1254-3"></span>**[BUSCTRL](#page-1253-1): BUS_PRIORITY_ACK Register**
...
*Table 1321. BUS_PRIORITY_ACK Register*
...
# <span id="page-1254-1"></span>**[BUSCTRL](#page-1253-1): PERFCTR_EN Register**

**Offset**: 0x08

*Table 1322. PERFCTR_EN Register*
