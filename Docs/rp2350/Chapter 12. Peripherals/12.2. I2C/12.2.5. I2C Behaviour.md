# <span id="page-985-0"></span>**12.2.5. I2C Behaviour**
...
The I2C protocols implemented in DW_apb_i2c are described in more details in [Section 12.2.6](#page-986-0).

#### **12.2.5.1. START and STOP Generation**

When operating as an I2C master, putting data into the TX FIFO causes the DW_apb_i2c to generate a START condition on the I2C bus. Writing a 1 to [IC_DATA_CMD.](#page-1011-0)STOP causes the DW_apb_i2c to generate a STOP condition on the I2C bus; a STOP condition is not issued if this bit is not set, even if the TX FIFO is empty.
