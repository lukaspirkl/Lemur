# <span id="page-1044-2"></span>**12.3.3. Functional Description**
...
The PCLK and SSPCLK clock inputs in [Figure 90](#page-1045-0) are connected to the clk_sys and clk_peri system-level clock nets on RP2350, respectively. By default, clk_peri attaches directly to the system clock. However, you can detach it to maintain constant SPI frequency if the system clock is varied dynamically. See [Figure 32](#page-510-2) for an overview of the RP2350 clock architecture.
