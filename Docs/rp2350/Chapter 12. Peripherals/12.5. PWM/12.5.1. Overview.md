# <span id="page-1074-0"></span>**12.5.1. Overview**
...
- Added a second shared interrupt line (controlled by [IRQ1_INTE\)](#page-1090-0), to aid use of PWM slices as simple repeating timers.
