# <span id="page-1102-0"></span>**12.6.7. Bus Error Handling**
...
Upon encountering a bus error, the DMA halts the offending channel and reports the error through the channel's [CH0_CTRL_TRIG](#page-1124-0).READ_ERROR and WRITE_ERROR flags. The channel stops scheduling bus accesses.
