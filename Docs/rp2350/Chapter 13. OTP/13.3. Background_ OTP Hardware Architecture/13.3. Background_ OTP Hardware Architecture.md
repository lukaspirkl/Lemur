# <span id="page-1267-0"></span>**13.3. Background: OTP Hardware Architecture**
...
The OTP subsystem clock is initially provided by the OTP boot oscillator ([Section 13.3.3](#page-1269-0)) during hardware startup, but switches to clk_ref before any software runs on the processors. The frequency of clk_ref must not exceed 25 MHz when accessing the OTP.
