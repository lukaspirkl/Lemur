# <span id="page-25-0"></span>**2.1.1. Bus Priority**

The main AHB5 crossbar implements a two-level bus priority scheme. Priority levels are configured separately for core 0, core 1, DMA read and DMA write, using the [BUS_PRIORITY](#page-1253-0) register in the BUSCTRL register block.
