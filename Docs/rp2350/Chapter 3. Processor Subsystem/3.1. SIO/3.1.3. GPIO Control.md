# <span id="page-39-0"></span>**3.1.3. GPIO Control**
...
All SIO GPIO control registers come in pairs. The lower-addressed register in each pair (e.g. [GPIO_IN](#page-61-0)) is connected to GPIOs 0 through 31, and the higher-addressed register in each pair (e.g. [GPIO_HI_IN\)](#page-61-1) is connected to GPIOs 32 through 47, the QSPI pins, and the USB DP/DM pins.
...
- Output registers, [GPIO_OUT](#page-61-2) and [GPIO_HI_OUT](#page-62-0) set the output level of the GPIO. 0 for low output, 1 for high output.
- Output enable registers, [GPIO_OE](#page-64-0) and [GPIO_HI_OE,](#page-64-1) are used to enable the output driver. 0 for high-impedance, 1 for drive high or low based on [GPIO_OUT](#page-61-2) and [GPIO_HI_OUT.](#page-62-0)
- Input registers, [GPIO_IN](#page-61-0) and [GPIO_HI_IN,](#page-61-1) allow the processor to sample the current state of the GPIOs.

Reading [GPIO_IN](#page-61-0) returns up to 32 input values in a single read, and software then masks out individual pins it is interested in.

*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h#L859-L869) Lines 859 - 869*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h#L908-L914) Lines 908 - 914*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h#L955-L961) Lines 955 - 961*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_gpio/include/hardware/gpio.h#L1145-L1170) Lines 1145 - 1170*
