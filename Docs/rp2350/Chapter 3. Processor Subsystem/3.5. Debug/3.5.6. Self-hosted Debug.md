# <span id="page-87-2"></span>**3.5.6. Self-hosted Debug**
...
The self-hosted debug window starts at address 0x40140000 [\(CORESIGHT_PERIPH_BASE](#page-31-1)). The offsets of the APs within this window are the same as the APs' addresses when accessed from the SW-DP.
