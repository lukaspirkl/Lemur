# <span id="page-337-2"></span>**4.2. SRAM**
...
<span id="page-337-3"></span>Consecutive words in the system address space are routed to different RAM banks as shown in [Table 433.](#page-337-3) This scheme is referred to as **sequential interleaving**, and improves bus parallelism for typical memory access patterns.

4.1. ROM **337**

*Table 433. SRAM bank0/1/2/3 striped mapping.*
