# <span id="page-345-0"></span>**4.4.2. QSPI Memory Interface (QMI)**
...
- Memory-mapped reads and writes (writes must be enabled via [CTRL.](#page-346-2)WRITABLE_M0[/CTRL](#page-346-2).WRITABLE_M1)
