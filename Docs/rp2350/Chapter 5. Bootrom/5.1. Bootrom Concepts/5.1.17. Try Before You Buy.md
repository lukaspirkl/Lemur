# <span id="page-362-0"></span>**5.1.17. Try Before You Buy**
...
- 5. If the new image is valid (and correctly signed if necessary), it is entered under a watchdog timer, and has 16.7 seconds to mark itself OK via the [explicit_buy\(\)](#page-384-0) function.
