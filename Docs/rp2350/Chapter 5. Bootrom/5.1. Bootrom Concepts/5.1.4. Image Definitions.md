# <span id="page-355-1"></span>**5.1.4. Image Definitions**
...
For more information about how the bootrom discovers IMAGE_DEFs, see the section on [block loops](#page-356-1).

For details about the IMAGE_DEF format itself, see [Section 5.9.3](#page-419-0).
