# <span id="page-356-0"></span>**5.1.5. Blocks And Block Loops**
...
- PARTITION_TABLEs and IMAGE_DEFs are both present in the same block loop in the case of an [embedded partition table](#page-360-1).
