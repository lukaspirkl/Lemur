# <span id="page-428-0"></span>**5.10.2. Signed images**

![](_page_428_Picture_8.jpeg)

#### **TIP**

This section refers to the concepts of [block loops](#page-356-1) and [image definitions](#page-355-1) (and the associated IMAGE_DEF data structure) described in [Section 5.1.](#page-354-0) You should read the bootrom concepts section before this one.
