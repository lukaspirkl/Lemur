# <span id="page-431-1"></span>**5.10.4. A/B Booting**
...
When dragging a UF2 to the device, it will target whichever partition is not currently booting. The bootrom will then perform a FLASH_UPDATE boot into the new binary (see [Section 5.1.16\)](#page-361-0)
