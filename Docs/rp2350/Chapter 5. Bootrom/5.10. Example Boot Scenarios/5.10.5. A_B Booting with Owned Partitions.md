# <span id="page-433-0"></span>**5.10.5. A/B Booting with Owned Partitions**
...
Only the [get_uf2_target_partition\(\)](#page-392-0) bootrom function considers owner partitions. The [pick_ab_partition\(\)](#page-394-0) function always pick solely based on the A/B partition it is passed, in other words if passed partition 2, it would not look at partitions 0 and 1.
