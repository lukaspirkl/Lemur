# <span id="page-376-0"></span>**5.4. Bootrom APIs**
...
A categorised list is available in [Section 5.4.6.](#page-380-0)

The full alphabetical list is available in [Section 5.4.7](#page-382-0).
