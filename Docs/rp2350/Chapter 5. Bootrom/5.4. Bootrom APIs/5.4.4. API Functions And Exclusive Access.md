# <span id="page-379-0"></span>**5.4.4. API Functions And Exclusive Access**
...
- 0x1 : LOCK_FLASH_OP if owned, then a bootrom API is allowed to enter direct mode on the QSPI memory interface ([Section 12.14.5](#page-1232-0)) in order to perform low-level flash operations
