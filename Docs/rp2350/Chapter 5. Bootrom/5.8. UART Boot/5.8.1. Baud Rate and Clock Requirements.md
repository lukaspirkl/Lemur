# <span id="page-414-1"></span>**5.8.1. Baud Rate and Clock Requirements**
...
By default the crystal is assumed to be 12 MHz, but the [BOOTSEL_PLL_CFG](#page-1310-1) and [BOOTSEL_XOSC_CFG](#page-1311-0) OTP locations override this to achieve a nominal 48 MHz system clock from any supported crystal. The same OTP configuration is used for both USB and UART boot.
