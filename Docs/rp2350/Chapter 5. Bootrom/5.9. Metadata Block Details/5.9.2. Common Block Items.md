# <span id="page-417-0"></span>**5.9.2. Common Block Items**
...
#### <span id="page-418-1"></span>**5.9.2.2. HASH_DEF item**
...
The most recent LOAD_MAP item (see [Section 5.9.3.2\)](#page-420-0) that defines *what* to hash.

#### <span id="page-418-0"></span>**5.9.2.3. HASH_VALUE item**
...
This HASH_VALUE item is paired with the most recent HASH_DEF item [\(Section 5.9.2.2\)](#page-418-1) which defines what is being hashed.
...
This SIGNATURE item is paired with the most recent HASH_DEF item [\(Section 5.9.2.2](#page-418-1)) which defines what the hash value whose signature is checked.
