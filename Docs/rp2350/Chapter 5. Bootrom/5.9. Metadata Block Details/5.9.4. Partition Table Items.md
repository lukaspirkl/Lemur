# <span id="page-423-0"></span>**5.9.4. Partition Table Items**
...
These permissions are only advisory to Secure code, however they are respected by [flash_op\(\),](#page-386-0) the PICOBOOT flash access commands, and UF2 downloads.
