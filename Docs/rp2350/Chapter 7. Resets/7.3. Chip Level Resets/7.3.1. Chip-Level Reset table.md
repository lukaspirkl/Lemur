# <span id="page-492-1"></span>**7.3.1. Chip-Level Reset table**
...
Indicates the [CHIP_RESET.](#page-467-0)DOUBLE_TAP bit is reset.

#### **Rescue**

Indicates changes to the [CHIP_RESET](#page-467-0).RESCUE_FLAG bit.
