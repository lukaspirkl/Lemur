# <span id="page-511-0"></span>**8.1.1. Clock sources**
...
The list of clock sources is different per clock generator and can be found as enumerated values in the CTRL register. See [CLK_SYS_CTRL](#page-535-0) as an example.
