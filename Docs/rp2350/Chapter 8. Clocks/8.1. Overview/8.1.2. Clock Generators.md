# <span id="page-515-0"></span>**8.1.2. Clock Generators**
...
For a full list of clock sources for each clock generator, see the appropriate CTRL register. For example, [CLK_SYS_CTRL](#page-535-0).
...
By default, the WAKE_EN and SLEEP_EN registers reset to 0x1, which enables all clocks. Only use this feature for lowpower designs.
