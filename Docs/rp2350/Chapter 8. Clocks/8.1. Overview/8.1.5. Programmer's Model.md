# <span id="page-519-1"></span>**8.1.5. Programmer's Model**

#### <span id="page-519-2"></span>**8.1.5.1. Configuring a clock generator**

The SDK defines an enum of clocks:

*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware_structs/include/hardware/structs/clocks.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware_structs/include/hardware/structs/clocks.h#L30-L42) Lines 30 - 42*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware_structs/include/hardware/structs/clocks.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2350/hardware_structs/include/hardware/structs/clocks.h#L116-L137) Lines 116 - 137*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L40-L133) Lines 40 - 133*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/pico_runtime_init/runtime_init_clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/pico_runtime_init/runtime_init_clocks.c#L100-L104) Lines 100 - 104*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L137-L139) Lines 137 - 139*
...
- 2. Set the mux position of the source they want to measure. See [FC0_SRC.](#page-543-1)
- 3. Wait for the DONE status bit in [FC0_STATUS](#page-544-0) to be set.
- 4. Read the result.

The SDK defines a frequency_count function which takes the source as an argument and returns the frequency in kHz:

*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L147-L174) Lines 147 - 174*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/include/hardware/clocks.h](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/include/hardware/clocks.h#L377-L379) Lines 377 - 379*
...
The frequency counter can also be used in a test mode. This allows the hardware to check if the frequency is between a minimum and a maximum frequency, set in [FC0_MIN_KHZ](#page-542-1) and [FC0_MAX_KHZ](#page-543-2). This mode will set one of the following bits in [FC0_STATUS](#page-544-0) when DONE is set:
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L245-L276) Lines 245 - 276*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L313-L343) Lines 313 - 343*
...
*SDK: [https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c](https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/hardware_clocks/clocks.c#L221-L243) Lines 221 - 243*
...
The SLEEP_EN registers set what clocks run in sleep mode. The hello_sleep example ([hello_sleep_aon.c](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c) [in the](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c) [pico](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c)[playground](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c) [GitHub repository](https://github.com/raspberrypi/pico-playground/blob/master/sleep/hello_sleep/hello_sleep_aon.c)) illustrates how to put the chip to sleep until the AON Timer fires.
...
*Pico Extras: [https://github.com/raspberrypi/pico-extras/blob/master/src/rp2_common/pico_sleep/sleep.c](https://github.com/raspberrypi/pico-extras/blob/master/src/rp2_common/pico_sleep/sleep.c#L159-L183) Lines 159 - 183*
