...
The User Bank IO registers start at a base address of 0x40028000 (defined as [IO_BANK0_BASE](#page-31-1) in SDK).
...
||0x3 → HIGH: drive output high|||
|11:5|Reserved.|-|-| 
|4:0|FUNCSEL: 0-31 → selects pin function according to the gpio table RW 0x1f 31 == NULL|RW|0x1f|
||Enumerated values:|||
||0x00 → JTAG_TMS|||
||0x01 → SPI0_SS_N|||
||0x02 → UART0_RX|||
...
### IRQSUMMARY_PROC0_SECURE1 Register
...
### IRQSUMMARY_PROC0_NONSECURE0 Register
...
### IRQSUMMARY_PROC0_NONSECURE1 Register
...
### IRQSUMMARY_PROC1_SECURE1 Register
...
### IRQSUMMARY_PROC1_NONSECURE0 Register
...
### IRQSUMMARY_PROC1_NONSECURE1 Register
