...
public class OtpDataTests
{
    ...
    public void HardcodedRandomValues()
    {
        ...
        Assert.Equal((uint)0xCFAFF9B0, BitConverter.ToUInt32(rp2350.MemoryRead(StartAddress + 0x00, 4)));
        Assert.Equal((uint)0x9F6D2E4B, BitConverter.ToUInt32(rp2350.MemoryRead(StartAddress + 0x04, 4)));
        //Assert.Equal((uint)0x86BB3FC6, BitConverter.ToUInt32(rp2350.MemoryRead(StartAddress + 0x08, 4)));
